...
MOCK_API_KEY = "s" # Replace with your key if needed, or use environment variable
IMAGE_PATH = "game_logic/test_pic_0.jpg"
USE_MOCK_API = True # Set to True to use mock data instead of making real API calls
